...
import { createTulongLoan, addTulongPayment, createBorrowerLogin, resetBorrowerPassword, setBorrowerActive } from "./actions";
...
export default async function TulongFinancialPage({
  ...
  const [{ data: loanRows }, { data: paymentRows }, { data: memberRows }, { data: localRows }, { data: borrowerRows }] =
    await Promise.all([
      supabase
