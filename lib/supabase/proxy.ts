...
// Bukas sa lahat: ang home page, I'm New, About Us, Our History (para sa mga bisita), at ang Contact Us (para makapagpadala ng mensahe kahit hindi member).
// Ang ibang pahina (Leadership, Sermons, Events, portal) ay kailangan ng login.
