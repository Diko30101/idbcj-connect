...
import { saveLocalYearlyFinancials } from "@/app/portal/actions";
...
export function LocalYearlyFinanceGrid({ year, categories, categoryLabel, initial }: Props) {
  ...
  return (
    <form action={saveLocalYearlyFinancials}>
      <input type="hidden" name="year" value={year} />
      <p className="mb-3 text-sm text-gray-500">
        I-edit ang alinmang buwan kung may mali, tapos i-save.
      </p>
